...
import PopupInstructionsModal from '../components/PopupInstructionsModal';
...
const WelcomePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    gsap.set([logoRef.current, titleRef.current, descriptionRef.current, buttonRef.current], {
      opacity: 0,
      y: 50,
      scale: 0.8
    });
    ...
    .to(buttonRef.current, {
      ...
      onComplete: () => {
        ...
        // Mostrar modal de instrucciones después de 2 segundos
        setTimeout(() => {
    ...
    return () => {
      tl.kill();
      gsap.killTweensOf([logoRef.current, titleRef.current, descriptionRef.current, buttonRef.current, bg1Ref.current, bg2Ref.current, bg3Ref.current]);
    };
  }, []);
