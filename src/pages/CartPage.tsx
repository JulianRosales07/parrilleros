    ...
    <Layout title="Tu pedido" showBack onBack={handleBackToMenu}>
      <div className="container mx-auto max-w-2xl py-6 px-4">
        ...
        <button
          ...
          className="w-full py-4 bg-[#FF8C00] text-white font-bold rounded-lg hover:bg-orange-600 transition-colors text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] flex items-center justify-center gap-2"
        >
