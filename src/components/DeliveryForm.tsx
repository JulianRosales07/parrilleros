...
📍 ${selectedLocation?.name} | ${selectedLocation?.phone}`;
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      ...
      // Automatically download the ticket
  ...
  if (orderSubmitted) {
    ...
    return (
      <div
        className="min-h-screen bg-gradient-to-br from-green-50 to-orange-50 flex items-center justify-center p-4"
        style={{
...
>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-transparent-100 rounded-lg shadow-md p-6" data-tour="order-summary-delivery">
            <OrderSummary />
          </div>
        </div>
