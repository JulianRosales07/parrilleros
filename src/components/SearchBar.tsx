          ...
          <div className="absolute top-full left-0 right-0 mt-3 text-center opacity-0 group-focus-within:opacity-100 transition-opacity duration-300">
            <div className="inline-flex items-center space-x-4 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-2xl shadow-lg border border-gray-100">
              ...
              <div className="flex space-x-3">
                <span className="bg-[#FF8C00]/10 text-[#FF8C00] px-3 py-1 rounded-full text-sm font-medium cursor-pointer hover:bg-[#FF8C00]/20 transition-colors" onClick={() => handleSearch('super meat')}>
                  🍔 super meat
                </span>
                <span className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-sm font-medium cursor-pointer hover:bg-blue-100 transition-colors" onClick={() => handleSearch('limonada')}>
                  🥤 bebidas
                </span>
